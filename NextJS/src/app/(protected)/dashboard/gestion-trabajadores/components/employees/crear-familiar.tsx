...
import { BookOpenText, CalendarDots, WarningCircle, IdentificationCard, Database, Heartbeat, MagnifyingGlass, TShirt } from "@phosphor-icons/react";
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                      <fieldset className="p-3 " dir="rtl">
                        <div dir="ltr">
                          <div>
                            <div
                              className={`grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 `}
                            >
                              <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2 border-green-600 rounded-sm">
                              ...
                              <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2 border-amber-700 rounded-sm">
                                <legend className="flex gap-2 text-amber-700 font-bold">
                                  {" "}
                                  Relación Y Parentesco <IdentificationCard />{" "}
                                </legend>
                                <FormField
                                  control={form.control}
                                  name={`parentesco`}
                              ...
                              <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2  border-blue-700 rounded-sm">
                                <legend className="flex gap-2 text-blue-700 font-bold">
                                  Información Academica <BookOpenText />
                                </legend>
                                <FormField
                                  control={form.control}
                                  name={`formacion_academica_familiar.nivel_Academico_id`}
                              ...
                              <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2 border-purple-900 rounded-sm">
                                <legend className="flex flex-row gap-2 text-purple-900 font-bold">
                                  Información de Vestimenta <TShirt />
                                </legend>
                              ...
                              <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2 border-red-700 rounded-sm">
                                <legend className="flex gap-2 text-red-700 font-bold">
                                  Datos De Salud <Heartbeat />
                                </legend>
                                <FormField
                                  control={form.control}
