...
import { CalendarDots, DownloadSimple, Eraser, MagnifyingGlass } from "@phosphor-icons/react";
        ...
        <Form {...form}>
          {isPending ? (
            ...
            <form
              ...
              className="space-y-4 grid grid-cols-1 lg:grid-cols-3 min-h-max gap-2"
            >
              <div className="flex flex-col gap-2 col-span-3">
                <ScrollArea className="h-100 ">
                  {session.user.role.nombre_rol == "ADMINISTRADOR" && (
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-emerald-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 ">
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-blue-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold flex justify-between gap-2 items-center text-sm">
                    ...
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-violet-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
                    ...
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-amber-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
                    ...
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-rose-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
                        Información Basica
                      </legend>
                      <FormField
                    ...
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-cyan-500 border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
                    ...
                    <fieldset className="flex flex-col gap-3 p-3 rounded-lg border border-border/50 bg-card/40 border-l-primary border-l-[3px]">
                      <legend className="text-foreground font-semibold text-sm">
              ...
              <div className="flex flex-row gap-2 flex-1 w-full col-span-3">
                ...
                {reportListEmployee && (
                  ...
                  >
                    Descargar Reporte <DownloadSimple />
                  </a>
                )}
                <Button
