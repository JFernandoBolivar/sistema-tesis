...
export function CodeListPage() {
  ...
  return (
    <Card className="bg-white/70 dark:bg-background/80 backdrop-blur-sm shadow-none border-none w-full max-w-5xl mx-auto">
        <CardHeader>
          <CardTitle>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSearch)}>
              <div className="flex flex-row items-center gap-2 w-full flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full min-w-0">
                  <FormField
                    name="codigo"
