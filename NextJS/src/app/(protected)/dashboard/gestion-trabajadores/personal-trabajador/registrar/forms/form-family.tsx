...
import { BookOpenText, CalendarDots, CaretDown, CaretUp, IdentificationCard, Database, Heartbeat, Spinner as SpinnerIcon, Plus, TShirt, Trash } from "@phosphor-icons/react";
              ...
              <legend className="text-lg font-semibold">
                <div className="flex justify-end gap-2 mb-4">
                  ...
                  <div>
                    ...
                    >
                      Recargar Datos
                      {!reload ? <SpinnerIcon /> : <SpinnerIcon />}
                    </Button>
                  </div>
                  <div>
                    <Button
                ...
                {fields.map((field, index) => {
                  ...
                  return (
                    <div key={field.id}>
                      ...
                      <div
                        className={`grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 ${isExpanded ? "" : "hidden"}`}
                        key={field.id}
                      >
                        <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2">
                        ...
                        <fieldset className="border grid grid-cols-1 md:grid-cols-2 gap-2 space-y-4 col-span-2 p-2">
                          <legend className="flex gap-2">
                            {" "}
                            Relacion Y Parentesco <IdentificationCard />{" "}
                          </legend>
                          <FormField
                            control={form.control}
