...
import { ArrowDown, ArrowUp, CalendarDots, CaretDown, Cross, Trash, X } from "@phosphor-icons/react";
              ...
              <ScrollArea className="h-60   rounded-md w-full border p-2">
                ...
                {fields.map((field, index) => (
                  <>
                    <div
                      key={field.id}
                      className="grid grid-cols-1 md:grid-cols-2 gap-5 space-y-5 place-items-center w-full"
                    >
                      <FormField
                        control={form.control}
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              {" "}
                              {index + 1}. Fecha Inicio <ArrowDown />
                            </FormLabel>
                            <Popover>
                              <PopoverTrigger asChild>
                                <FormControl>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>
                              {index + 1}. Fecha Culminacion <ArrowUp />
                            </FormLabel>
                            <Popover>
                              <PopoverTrigger asChild>
                                <FormControl>
